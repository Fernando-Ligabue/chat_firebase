...
firebase.initializeApp({
  apiKey: "AIzaSyDpcTVARvCZk1vOnq16ULK-OxqWZgztD94",
  authDomain: "chatfire-ff741.firebaseapp.com",
  projectId: "chatfire-ff741",
  storageBucket: "chatfire-ff741.appspot.com",
  messagingSenderId: "1079937750576",
  appId: "1:1079937750576:web:4687cdd54711a18a5fbff5",
  measurementId: "G-V1LW707DM5"
});
...
function App() {
      ...
      <div className="flex items-center justify-center shadow-md h-full">
        <div className="flex flex-col items-center justify-center max-w-xl w-full mx-4 p-8 rounded-md shadow-card bg-white dark:bg-coolDark-600 transition-all">
          ...
          <p className="mb-8 text-lg text-center">
            The simple chat building with React and Firebase.
          </p>
          <button
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-coolDark-500 dark:text-white transition-colors">
      ...
      >
        <a href="/">
          <img src={brandLogo} alt="ChatFire" width={100} />
        </a>
